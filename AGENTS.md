...
6. `SIZE.md` — the Resource Sizing Guide, if the change alters the system requirements, memory profile, or performance characteristics of the browser sessions.
